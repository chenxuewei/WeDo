...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>微度 - 微信公众平台自助引度 -  Powered by WE7.CC</title>
    <meta name="keywords" content="">
    <meta name="description" content="微信公众平台自助引度，简称微度，微度是一款免费开源的微信公众平台管理系统。">
...
<div class="main" align="center">
        ...
        <div class="form form-horizontal">
            ...
            <table class="tb table-striped">
                ...
                当前APP：<tr><td><input type="text" disabled value="<?=$user['aname']?>"></td></tr>

                <?php
                if($menu !=''){foreach($menu['button'] as $v){
                        ...
                        <tr class="hover" data-do="view" data-url="" data-forward="">
                            <td>
                                ...
                                <div class="smlist ui-sortable">
                                    <?php foreach($v['sub_button'] as $val ){?>
                                        <div style="margin-top:20px;padding-left:80px;background:url(&#39;./menu/bg_repno.gif&#39;) no-repeat -245px -545px;" data-do="<?=$val['type']?>"  <?php if($val['type']=='view'){echo "data-url='{$val['url']}'";}else{ echo "data-forward=".'"'.$val['key'].'"';} ?>>
                                            <input type="text" class="span3" value="<?=$val['name']?>"> &nbsp; &nbsp;
                                            <a href="javascript:;" class="icon-move" title="拖动调整此菜单位置"></a> &nbsp;
                                            <a href="javascript:;" onclick="setMenuAction($(this).parent());" class="icon-edit" title="设置此菜单动作"></a> &nbsp;
                                            <a href="javascript:;" onclick="deleteMenu(this)" class="icon-remove-sign" title="删除此菜单"></a>
                                        </div>
            ...
            <table class="tb">
                ...
                <tr>
                    <td>
                        <input type="submit" value="保存菜单结构" class="btn btn-primary span3" onclick="saveMenu()">
...
<form action="?r=menu/menuinfo" method="post" id="form"><input id="do" name="do" type="hidden">  <input type="hidden" name="_csrf" value="<?php echo Yii::$app->request->csrfToken;?>" /> </form>
    ...
    <div class="tab-pane" id="url">
        <div class="well">
            ...
            <div id="forward-container" class="hide">
                ...
                <span class="help-block">指定点击此菜单时要执行的操作, 你可以在这里输入关键字, 那么点击这个菜单时就就相当于发送这个内容至微度系统</span>
                <span class="help-block"><strong>这个过程是程序模拟的, 比如这里添加关键字: 优惠券, 那么点击这个菜单是, 微度系统相当于接受了粉丝用户的消息, 内容为"优惠券"</strong></span>
            </div>
        </div>
    </div>
...
<div id="footer">
		<span class="pull-left">
			<p>Powered by <a href="http://www.we7.cc/"><b>微度</b></a> v0.52 © 2014 <a href="http://www.we7.cc/">www.we7.cc</a></p>
		</span>
		<span class="pull-right">
			<p><a href="http://www.we7.cc/">关于微度</a>&nbsp;&nbsp;<a href="http://bbs.we7.cc/">微度帮助</a></p>
		</span>
</div>
