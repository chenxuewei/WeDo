...
<!--主体-->
<div class="main">
    <form action="?r=menu/menuinfo" method="post">
        ...
        <div class="form form-horizontal">
            ...
            <table class="tb table-striped">
                ...
                <?php  foreach($menu['selfmenu_info']['button'] as $v){
                        ...
                        <tr class="hover" data-do="view" data-url="" data-forward="">
                            <td>
                                ...
                                <div class="smlist ui-sortable">
                                    <?php foreach($v['sub_button']['list'] as $val ){?>
                                        <div style="margin-top:20px;padding-left:80px;background:url(&#39;./menu/bg_repno.gif&#39;) no-repeat -245px -545px;" data-do="<?=$val['type']?>" data-url="<?php if($val['type']=='view'){echo $val['url'];}else{ echo $val['key'];} ?>" data-forward="">
